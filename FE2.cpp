...
if(myrank == 0)
{
	...
	{
	    fem(nodes_macro, elements_macro, physicals_macro, parameters_macro, solutionTemperature_macro, solutionFlux_macro, thermalOrElectrical, DIRICHLETFLAG, conditions_macro, eps, type);
	}
	else if(type == FE2withVONNEUMANN)
	{
	    fem(nodes_macro, elements_macro, physicals_macro, parameters_macro, solutionTemperature_macro, solutionFlux_macro, thermalOrElectrical, VONNEUMANNFLAG, conditions_macro, eps, type);
	}
}
